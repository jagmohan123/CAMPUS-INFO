    ...
    <section class="w3l-contacts-12" id="contact">
            ...
            <div class="contacts12-main py-md-3">
                ...
                <form action="https://sendmail.w3layouts.com/submitForm" method="post" class="">
                    <div class="main-input">
                        ...
                        <input type="email" name="w3lSender" placeholder="Enter your mail /Phone No." class="contact-input" required="" />
                        <input type="password" name="w3lSubject" placeholder="password" class="contact-input" />
        ...
        <div class="contant11-top-bg py-5">
            <div class="container py-lg-3">
                <div c="d-grid contact section-gap">
                    <div class="contact-info-left d-grid">
                        <div class="contact-info">
                            ...
                            <div class="contact-details">
                                <h4>Address:</h4>
                                <p>Sai Colony Near Of Deendayal at jabalpur</p>
                            </div>
                        </div>
                        <div class="contact-info">
                            <div class="icon">
                            ...
                            <div class="contact-details">
                                <h4>Phone:</h4>
                                <p><a href="tel:+598-658-456">+918770548022</a></p>
                                <p><a href="tel:+598-658-457">+918223011820</a></p>
                            </div>
                        </div>
                        <div class="contact-info">
                            <div class="icon">
                            ...
                            <div class="contact-details">
                                <h4>Mail:</h4>
                                <p><a href="mailto:mail@example.com" class="email">getinfo@gmail.com</a></p>
