...
<body>
    ...
    <div>
        <form action="#" method="POST">
            ...
            <tr>
                    <td>firstname :</td>
                    <td><input type="text" name="fname" class="register" placeholder="Role "></td>
                </tr>
                <tr>
                    <td>lastname:</td>
                    <td><input type="text"  name="lname" class="register" placeholder="Role "></td>
                </tr>
                <tr>
                    <td> Email :</td>
                ...
                <tr>
                    <td> password :</td>
                    <td><input type="password" id="password" name="pwd"  placeholder="Enter your password"/></td>
                </tr>
        ...
        if (isset($_POST['insert'])) {
           ...
           $lname=$_POST['lname'];
            ...
            $branch = $_POST['branch'];
            $passoutyaer = $_POST['passoutBatch'];
            ...
            $qur="insert into userskill (FirstName,LastName,EmailId,Password,CollageName,Branch,PassoutYear,WhatsappNo,City,Gender )
            values('$fname','$lname','$email','$pass','$collage_name','$branch',$passoutyaer,'$whatsapp_no','$city','$gender')";
